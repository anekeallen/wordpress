			...
			<div class="twp-row">
			    <div class="col-lg-6  twp-col-gap">
			    	<div class="site-info">
			    		...
			    		?>
			    		<p><?php echo date("Y"); ?> &copy; Copyright. Todos os direitos reservados</p>
			    ...
			    <div class="desenvolvedor ml-1 mt-1 mt-lg-3">Desenvolvido por: <a title="DevAllen - Desenvolvedor Web" target="_blank" href="https://devallen.com.br/">DevAllen</a></div>
