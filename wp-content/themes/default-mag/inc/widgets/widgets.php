                        ...
                        <li class="twp-post twp-post-style-1">
                            <div class="twp-image-section twp-image-70">
                                ...
                                <?php if (has_post_thumbnail($post->ID)){?>
                                    ...
                                    <?php if (!empty($image)):?>
                                        <div class="twp-image data-bg " style="background-image:url(<?php echo esc_url($image[0]);?>)"></div>
                                    <?php endif;?>
                                <?php  } ?>
                            </div>
                ...
                <div class="twp-home-page-widget-style-1-section">
                    <div class="twp-d-flex">                
                        <?php foreach ($all_posts as $key => $post) : ?>
                            ...
                            <?php } else { ?>
                                <?php if ($count <= 2) {
                                    echo '<div class="twp-widget-post-list-section"><ul class="twp-post-list twp-post-with-categories-list">';
                                } ?>
    ...
    class TWP_Homepage_widget_style_2 extends Default_Mag_Widget_Base
    {
        ...
        function widget($args, $instance)
        {
            ...
            echo "<div class='container'>";
                ...
                ?>
                <?php if (!empty($all_posts)) : ?>
                <div class="twp-home-page-widget-style-2-section">
                    <div class="twp-row">                
                        <?php foreach ($all_posts as $key => $post) : ?>
                            <?php setup_postdata($post); ?>
                            <?php if ($count <= 2) { ?>
                                <?php if ($count == 1) {
                                    echo '<div class="twp-col twp-col-sm-6 twp-col-lg-3"><div class="twp-block-post-list">';
                                } ?>
                                <?php if (has_post_thumbnail()) {
                                    $thumb = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'default-mag-900-600' );
                                    $url = $thumb['0'];
                            ...
                            <?php } else { ?>
                                <?php if ($count <= 3) {
                                    echo '<div class="twp-col twp-col-sm-6 twp-col-lg-5"><ul class="twp-post-list">';
                                } ?>
                                ...
                                <li class="twp-post twp-post-style-1">
                                    ...
                                    <div class="twp-desc">
                                            <?php if (true === $params['enable_post_meta']) { ?>
                                            <div class="twp-categories-wrapper twp-row">
                                                 <div class="twp-col-gap twp-categories twp-secondary-categories">
                                                    <?php default_mag_post_categories(); ?>
                                                </div>
                                                <div class="twp-col-gap twp-author-desc twp-primary-color">
                                                    <?php default_mag_post_date(); ?>
                                                </div>
                                            </div>
                                        <?php } ?>
                            ...
                            <?php if ( ! empty( $params['image_url_add'] ) ) { ?>
                                <div class="twp-col twp-col-lg-4 twp-ad-image-section">
