				...
				<div class="twp-single-next-post twp-secondary-font">
					<h3 class="twp-title">
						<a href="<?php echo esc_url( get_permalink( $next_post->ID ) ); ?>">
							<?php echo esc_html__('Próxima Notícia','default-mag'); ?><i class="fa fa-chevron-right"></i>
						</a>
					</h3>
						...
						if ($post_categories) {
							...
							foreach ($post_categories as $post_category) {
								$output .= '<li class="float-left">
										<a class="default-mag-categories twp-primary-anchor-text--" href="' . esc_url(get_category_link($post_category)) . '" alt="' . esc_attr(sprintf(__('
											Ver todas as postagens em %s', 'default-mag'), $post_category->name)) . '"> 
